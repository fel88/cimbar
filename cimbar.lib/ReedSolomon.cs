namespace cimbar.lib
{
    public class ReedSolomon
    {
        ...
        int correct_reed_solomon_encode(correct_reed_solomon rs, byte[] msg, int msg_length, byte[] encoded)
        {
            ...
            int pad_length = rs.message_length - msg_length;
            ...
            polyomial.polynomial_mod(rs.field, rs.encoded_polynomial, rs.generator, rs.encoded_remainder);
            ...
            for (int i = 0; i < rs.min_distance; i++)
            {
